...
$jscomp.polyfill = function (d, c, a, b) {
    if (c) {
        ...
        b = a[d];
        c = c(b);
        c != b && null != c && $jscomp.defineProperty(a, d, { configurable: !0, writable: !0, value: c })
    }
};
    ...
    c.prototype.executeBatch_ = function () {
        for (; this.batch_ && this.batch_.length;) {
            ...
            for (var b = 0; b < a.length; ++b) {
                var c = a[b];
                delete a[b];
                try { c() } catch (m) { this.asyncThrow_(m) }
            }
        }
        this.batch_ = null
    };
...
$jscomp.polyfill("Object.assign", function (d) {
    return d ? d : function (c, a) {
        for (var b = 1; b < arguments.length; b++) {
            var d = arguments[b];
            if (d)
                for (var f in d) $jscomp.owns(d, f) && (c[f] = d[f])
        }
        return c
    }
}, "es6", "es3");
$jscomp.polyfill("Array.from", function (d) {
    return d ? d : function (c, a, b) {
        ...
        if ("function" == typeof f)
            for (c = f.call(c); !(f = c.next()).done;) d.push(a.call(b, f.value));
        else { f = c.length; for (var h = 0; h < f; h++) d.push(a.call(b, c[h])) }
        return d
    }
}, "es6", "es3");
...
(function (d) {
    ...
    (function (a) {
        (function () {
            ...
            function c(a) {
                ...
                e.start = 0;
                e.end = c.length;
                for (var C = e, T = 0, f = c.length; T < f; T++)
                    if ("{" === c[T]) {
                        C.rules ||
                            (C.rules = []);
                        var h = C,
            ...
            function d(a, b) {
                ...
                a.parent && (g = b.substring(a.previous ? a.previous.end : a.parent.start, a.start - 1), g = k(g), g = g.replace(oa, " "), g = g.substring(g.lastIndexOf(";") + 1), g = a.parsedSelector = a.selector = g.trim(), a.atRule = 0 === g.indexOf("@"), a.atRule ? 0 === g.indexOf("@media") ? a.type =
                    mb : g.match(Oa) && (a.type = Pa, a.keyframesName = a.selector.split(oa).pop()) : a.type = 0 === g.indexOf("--") ? nb : ob);
                if (g = a.rules)
                    for (var c = 0, p = g.length, e; c < p && (e = g[c]); c++) d(e, b);
                return a
            }
            ...
            function l(a, b, c) {
                ...
                if (a.cssText || a.rules) {
                    ...
                    if (p) {
                        p = 0;
                        for (var e = d.length, wa; p < e && (wa = d[p]); p++) g = l(wa, b,
                            g)
                    } else b ? b = a.cssText : (b = a.cssText, b = b.replace(pb, "").replace(Qa, ""), b = b.replace(xa, "").replace(K, "")), (g = b.trim()) && (g = "  " + g + "\n")
                }
                g && (a.selector && (c += a.selector + " {\n"), c += g, a.selector && (c += "}\n\n"));
                return c
            }

            function m(a) { ya = a && a.shimcssproperties ? !1 : x || !(navigator.userAgent.match(/AppleWebKit\/601|Edge\/15/) || !window.CSS || !CSS.supports || !CSS.supports("box-shadow", "0 0 0 var(--foo)")) }
            ...
            function v(a) {
                !a.__cssRules &&
                    a.textContent && (a.__cssRules = c(a.textContent));
            ...
            function Q(a) { return a ? a.__styleInfo : null }
            ...
            function ja(a, b) {
                var c = a.f;
                if (c) { if (c.i) return Object.assign(b, c.i), !0 } else {
                    c = a.parsedCssText;
            ...
            function Ua(a, b, c, d) {
                ...
                if (b.f.i) {
                    ...
                    var e = b.parsedSelector,
                        p = ":host > *" === e || "html" === e,
                        f = 0 === e.indexOf(":host") && !p;
                    "shady" === c && (p = e === g + " > *." + g || -1 !== e.indexOf("html"), f = !p && 0 === e.indexOf(g));
                    "shadow" === c && (p = ":host > *" === e || "html" === e, f = f && !p);
                    if (p || f) c = g, f && (b.g || (b.g = V(H, b, H.b, a ? U + a : "", g)), c = b.g || g), d({ K: c, I: f, R: p })
                }
            }
            ...
            function eb(a, b, c, d) {
                ...
                return ea(b, g, function (b) {
                    ...
                    if (!(x || b.parent && b.parent.type === Pa) && b.cssText) {
                        ...
                        if (b.B)
                            if (null == b.v) { b.v = []; for (var h in p) n = p[h], n = n(g), g !== n && (g = n, b.v.push(h)) } else {
                    ...
                    if (c.target !== document.documentElement && c.target !== document.head)
                        for (var d = 0; d < c.addedNodes.length; d++) {
                            ...
                            if (g.nodeType === Node.ELEMENT_NODE) {
                                ...
                                f = h;
                                h = f.indexOf(H.a);
                                if ((f = -1 < h ? f[h + 1] : "") && e === g.ownerDocument) N(g, f, !0);
                                    ...
                                    else f && N(g, f, !0), N(g, e)
                            }
                        }
                }
            }

            function la(a) { if (a = ca[a]) a._applyShimCurrentVersion = a._applyShimCurrentVersion || 0, a._applyShimValidatingVersion = a._applyShimValidatingVersion || 0, a._applyShimNextVersion = (a._applyShimNextVersion || 0) + 1 }
            ...
            function Za(a, b) { return (b = b.getRootNode().host) ? Q(b) ? b : Za(a, b) : a.c }
            ...
            G.prepareTemplateStyles = function (a, b, d) {
                if (!a.s) {
                    ...
                    e = [];
                    F || (e = Ta(a._styleAst));
                    if (!e.length || F) g = x ? a.content : null, b = ma[b], f = ea(d, a._styleAst), b = f.length ? P(f, d.is, g, b) : void 0, a.a = b;
                    a.l = e
                }
            };
            ...
            G.styleElement = function (a, b) {
                ...
                if (!d) {
                    ...
                    e = e.u;
                    var g = ma[d];
                    if (d = ca[d]) { var f = d._styleAst; var h = d.l }
                    f = new E(f, g, h, e);
                    d = a.__styleInfo = f
                }
                a !== this.c && (this.s = !0);
                ...
                if (F) {
                    if (d.o) { b = d.o; for (var n in b) null === n ? a.style.removeProperty(n) : a.style.setProperty(n, b[n]) }
                            ...
                            for (f = b.length - 1; 0 <= f; f--) {
                                ...
                                b: {
                                    ...
                                    for (e = 0; e < d.length; e++)
                                        if (g = d[e], h.i[g] !== c.m[g]) { d = !1; break b }
                                    d = !0
                                }
                                if (d) { b = h; break a }
                            }
                    ...
                    x ? g.a ? (g.a.textContent = e, d = g.a) : e && (d = P(e, h, a.shadowRoot, g.b)) :
                        d ? d.parentNode || (Ma && -1 < e.indexOf("@media") && (d.textContent = e), u(d, null, g.b)) : e && (d = P(e, h, null, g.b));
                    d && (d._useCount = d._useCount || 0, g.a != d && d._useCount++, g.a = d);
                    h = d;
                    x || (d = c.h, g = e = a.getAttribute("class") || "", f && (g = e.replace(new RegExp("\\s*x-scope\\s*" + f + "\\s*", "g"), " ")), g += (g ? " " : "") + "x-scope " + d, e !== g && L(a, g));
    ...
    function e(a, b, c) {
        ...
        switch (b) {
            case "text":
                var d = c.requestBody(a.queryInput.text.text, m.M.text);
                d = h(c, d);
                break;
            case "event":
                d = c.requestBody(a.queryInput.event, m.M.event);
                d = h(c, d);
                break;
            default:
    ...
    function f(a,
        b) {
        b.queryParams ? b.queryParams.payload || (b.queryParams.payload = {}) : b.queryParams = { payload: {} };
    ...
    c.b = function (a, c, d) {
        ...
        return new Promise(function (a, c) {
            ...
            if (f) Object(l.a)().newMessage(Object(l.a)().botWriting()), e.send(JSON.stringify(f)), Object(k.d)(d, m.V, { requestBody: f });
            else {
                var h = Object.assign({}, t.b);
                h.error.message = "Please specify query input (text or event)";
                b(h);
                c(h)
            }
    ...
    d = new Map([
        ...
        ["zh-CN", { askSomething: "\u8f93\u5165\u95ee\u9898\u2026", chatTitle: "\u804a\u5929", errorMessage: "\u51fa\u4e86\u70b9\u95ee\u9898\uff0c\u8bf7\u91cd\u8bd5", messageTooLong: "\u54ce\u5440\uff01\u60a8\u7684\u6d88\u606f\u8fc7\u957f\uff0c\u8d85\u51fa\u4e0a\u9650 numOfChars \u4e2a\u5b57\u7b26\u3002" }],
        ["zh-HK", {
        ...
        ["da", { askSomething: "Stil et sp\u00f8rgsm\u00e5l...", chatTitle: "Chat", errorMessage: "Der opstod en fejl, pr\u00f8v igen", messageTooLong: "Ups! Din besked fylder numOfChars tegn mere end det tilladte." }],
        ["nl", {
        ...
        ["fr", { askSomething: "Posez une question\u2026", chatTitle: "Chat", errorMessage: "Une erreur s'est produite. Veuillez r\u00e9essayer.", messageTooLong: "Petit probl\u00e8me\u2026 Votre message contient numOfChars caract\u00e8re(s) de trop." }],
        ["de", { askSomething: "Frage eingeben", chatTitle: "Chat", errorMessage: "Ein Fehler ist aufgetreten. Bitte probieren Sie es noch einmal.", messageTooLong: "Hoppla! Ihre Nachricht ist numOfChars Zeichen zu lang." }],
        ["hi", { askSomething: "\u0915\u0941\u091b \u092a\u0942\u091b\u0947\u0902...", chatTitle: "\u091a\u0948\u091f \u0915\u0930\u0947\u0902", errorMessage: "\u0915\u0941\u091b \u0917\u0921\u093c\u092c\u0921\u093c\u0940 \u0939\u0941\u0908 \u0939\u0948, \u0915\u0943\u092a\u092f\u093e \u092b\u093f\u0930 \u0938\u0947 \u0915\u094b\u0936\u093f\u0936 \u0915\u0930\u0947\u0902", messageTooLong: "\u0913\u0939! \u0906\u092a\u0915\u0947 \u092e\u0948\u0938\u0947\u091c \u092e\u0947\u0902 numOfChars \u0935\u0930\u094d\u0923 \u0939\u0948\u0902 \u091c\u094b \u092c\u0939\u0941\u0924 \u091c\u093c\u094d\u092f\u093e\u0926\u093e \u0939\u0948\u0902." }],
        ["id", { askSomething: "Tanyakan Sesuatu...", chatTitle: "Chat", errorMessage: "Terjadi masalah, harap coba lagi", messageTooLong: "Maaf. Pesan Anda berisi numOfChars karakter yang terlalu panjang." }],
        ["it", { askSomething: "Poni una domanda\u2026", chatTitle: "Chat", errorMessage: "Si \u00e8 verificato un errore. Riprova", messageTooLong: "Spiacenti, il messaggio supera di numOfChars caratteri la lunghezza consentita." }],
        ["ja", {
            askSomething: "\u8cea\u554f\u3092\u5165\u529b...",
            chatTitle: "\u30c1\u30e3\u30c3\u30c8",
        ...
        ["no", { askSomething: "Sp\u00f8r om noe \u2026", chatTitle: "Chat", errorMessage: "Noe gikk galt \u2013 pr\u00f8v p\u00e5 nytt", messageTooLong: "Beklager! Meldingen din er numOfChars tegn for lang." }],
        ["pt-BR", { askSomething: "Pergunte algo\u2026", chatTitle: "Bate-papo", errorMessage: "Ocorreu um erro. Tente novamente.", messageTooLong: "Ops! Sua mensagem tem numOfChars caracteres a mais que o limite." }],
        ["pt-PT", { askSomething: "Pergunte algo\u2026", chatTitle: "Chat", errorMessage: "Ocorreu um erro. Tente novamente mais tarde.", messageTooLong: "Ups! A sua mensagem tem numOfChars carateres a mais." }],
        ["ru", {
        ...
        ["es", { askSomething: "Haz una pregunta...", chatTitle: "Chat", errorMessage: "Se ha producido un error. Vuelve a intentarlo.", messageTooLong: "\u00a1Vaya! Tu mensaje tiene numOfChars caracteres m\u00e1s de lo permitido." }],
        ["sv", { askSomething: "Fr\u00e5ga n\u00e5got \u2026", chatTitle: "Chatt", errorMessage: "N\u00e5got gick fel. F\u00f6rs\u00f6k igen.", messageTooLong: "Hoppsan! Ditt meddelande \u00e4r numOfChars tecken f\u00f6r l\u00e5ngt." }],
        ["th", {
    ...
    a.prototype.connectedCallback = function () {
        ...
        var a = Object(m.c)("link", [], null, { href: "https://fonts.googleapis.com/icon?family=Material+Icons", rel: "stylesheet" }),
            b = Object(m.c)("link", [], null, { href: "https://fonts.googleapis.com/css?family=Roboto", rel: "stylesheet" });
    ...
    a.prototype.missingAttributes_ = function () {
        ...
        this.apiUri || (this.getAttribute(b.d) ? this.apiUri =
            "https://rameez-covid-cases.herokuapp.com/rameez-chat/bot" : this.apiUri = "https://dialogflow.googleapis.com/v2/projects");
        return a
    };
        ...
        return $jscomp.executeAsyncGenerator(function () {
            function d(d, k) {
                for (; ;) switch (e) {
                    ...
                    case 1:
                        if (void 0 === k) { e = 2; break }
                        e = -1;
                        throw k;
                    case 2:
                        f = h =
                            d, void 0 !== a && null !== a ? (c.chatIsMinimized_() ? Object(m.d)(c, t.k, {}) : (Object(m.a)("#" + b.p, f).classList.add("rotate-fade"), Object(m.a)("." + b.u, f).classList.add("hidden"), v || null === c.waitOpen || null === c.intent || c.initializeDFMessenger_(), Object(m.d)(c, b.l, {})), c.showChat_(), Object(m.a)(".df-messenger-wrapper", c.shadowRoot).classList.add("expanded")) : (Object(m.a)("#" + b.p, f).classList.remove("rotate-fade"), Object(m.a)("." + b.u, f).classList.remove("hidden"), c.hideChat_(), Object(m.d)(c, t.h, {}), Object(m.a)(".df-messenger-wrapper",
                                c.shadowRoot).classList.remove("expanded")), e = -1;
                    default:
    ...
    (function (a, c) { d.exports = c() })(this, function () {
        ...
        function l(a) { if (Array.isArray(a)) { for (var b = 0, c = Array(a.length); b < a.length; b++) c[b] = a[b]; return c } return Array.from(a) }
        ...
        function m() {
            ...
            var c = a.document,
                ...
                e = !1,
                f = a.document,
                t = a.DocumentFragment,
                v = a.Node,
                w = a.NodeFilter,
                q = a.NamedNodeMap,
                D = void 0 === q ? a.NamedNodeMap || a.MozNamedAttrMap : q,
                L = a.Text,
                M = a.Comment,
                Qa = a.DOMParser;
            q = a.trustedTypes;
            ...
            var oa =
                q.implementation,
                x = q.createNodeIterator,
                ya = q.getElementsByTagName,
            ...
            var Ia = eb,
                ...
                fa = Va,
                y = null,
                Ba = h({}, [].concat(l(Ha), l(Ta), l(ia), l(ja), l(ba))),
                z = null,
                Ea = h({}, [].concat(l(ta), l(Ja), l(Ua), l(ua))),
                Z = null,
                ha = null,
                ab = !0,
                ra = !0,
                ...
                da = !1,
                W = {},
                va = h({}, "annotation-xml audio colgroup desc foreignobject head iframe math mi mn mo ms mtext noembed noframes plaintext script style svg template thead title video xmp".split(" ")),
                kb = h({}, ["audio", "video", "img", "source", "image"]),
                ca = null,
                ...
                g = function (a) {
                    ...
                    a && c && b.body.insertBefore(f.createTextNode(c),
            ...
            var p = function (a) { return x.call(a.ownerDocument || a, a, w.SHOW_ELEMENT | w.SHOW_COMMENT | w.SHOW_TEXT, function () { return w.FILTER_ACCEPT }, !1) },
                ...
                C = function (a) {
                    ...
                    if (c) return S(a), !0;
                    c = V(a.nodeName);
                    B("uponSanitizeElement", a, { tagName: c, allowedTags: y });
                    ...
                    if ("noscript" === c && E(/<\/noscript/i, a.innerHTML) || "noembed" === c && E(/<\/noembed/i, a.innerHTML)) return S(a), !0;
                    !Da || a.firstElementChild || a.content && a.content.firstElementChild || !E(/</g, a.textContent) || (J(b.removed, { element: a.cloneNode() }), a.innerHTML = a.innerHTML ? O(a.innerHTML, /</g, "&lt;") : O(a.textContent, /</g, "&lt;"));
                    U && 3 === a.nodeType && (d = a.textContent, d = O(d, Ia, " "), d = O(d, Ka, " "), a.textContent !== d && (J(b.removed, { element: a.cloneNode() }), a.textContent = d));
                ...
                lb = function (a) {
                    ...
                    var e = a.attributes;
                    if (e) {
                        var g = { attrName: "", attrValue: "", keepAttr: !0, allowedAttributes: z };
                        for (d = e.length; d--;) {
                            var f = c = e[d],
                                h = f.name;
                            f = f.namespaceURI;
                            ...
                            if (!g.forceKeepAttr) {
                                ...
                                } else if ("INPUT" !== a.nodeName || "type" !== k || "file" !== c || !g.keepAttr || !z[k] && ha[k]) "id" === h && a.setAttribute(h, ""), Y(h, a);
                                else continue;
                                if (g.keepAttr)
                                    if (Da && E(/\/>/i, c)) Y(h, a);
            ...
            b.sanitize = function (d, e) {
                ...
                if (!b.isSupported) { if ("object" === la(a.toStaticHTML) || "function" === typeof a.toStaticHTML) { if ("string" === typeof d) return a.toStaticHTML(d); if (wa(d)) return a.toStaticHTML(d.outerHTML) } return d }
                za || A(e);
                b.removed = [];
                "string" === typeof d && (da = !1);
                if (!da)
                    if (d instanceof v) f = g("\x3c!--\x3e"), e = f.ownerDocument.importNode(d, !0), 1 === e.nodeType && "BODY" === e.nodeName ? f = e : "HTML" === e.nodeName ? f = e : f.appendChild(e);
                    else {
                        if (!H && !U && !aa && ma && -1 === d.indexOf("<")) return K ?
                            K.createHTML(d) : d;
                        f = g(d);
                        if (!f) return H ? null : Oa
                    }
                f && Fa && S(f.firstChild);
                for (var k = p(da ? d : f); e = k.nextNode();) 3 === e.nodeType && e === h || C(e) || (e.content instanceof t && ub(e.content), lb(e), h = e);
                if (da) return d;
                if (H) {
                    if (Ma)
        ...
        var N = c(Array.prototype.forEach),
            ...
            hb = q(/^data-[\-\w.\u00B7-\uFFFF]/),
            ib = q(/^aria-[\-\w]+$/),
            Va = q(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),
            Wa = q(/^(?:\w+script|data):/i),
            Xa = q(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205f\u3000]/g);
        $jscomp.initSymbol();
        $jscomp.initSymbol();
        $jscomp.initSymbolIterator();
    ...
    c.g = { title: "", subtitle: "", image: { src: { rawUrl: "" } }, event: { name: "", parameters: {}, languageCode: "" }, payload: {} };
    c.b = { icon: { type: "", color: "" }, text: "", link: "" };
    c.a = {
        title: "",
        subtitle: "",
        image: { src: "" },
    ...
    d.exports = function (b) {
        ...
        c.i = function (a,
            ...
            for (var d = {}, e = 0; e < this.length; e++) { var f = this[e][0]; "number" === typeof f && (d[f] = !0) }
    ...
    function b(a, b) {
        for (var c = 0; c < a.length; c++) {
            var d = a[c],
                e = u[d.id];
            if (e) { e.refs++; for (var f = 0; f < e.parts.length; f++) e.parts[f](d.parts[f]); for (; f < d.parts.length; f++) e.parts.push(t(d.parts[f], b)) } else {
                e = [];
                for (f = 0; f < d.parts.length; f++) e.push(t(d.parts[f],
                    b));
                u[d.id] = { id: d.id, refs: 1, parts: e }
            }
        }
    }
    ...
    function e(a, b) {
        for (var c = [], d = {}, e = 0; e < a.length; e++) {
            ...
            f = { css: f[1], media: f[2], sourceMap: f[3] };
            d[h] ? d[h].parts.push(f) : c.push(d[h] = { id: h, parts: [f] })
        }
        return c
    }
    ...
    function f(a, b) {
        ...
        if ("top" === a.insertAt) d ? d.nextSibling ? c.insertBefore(b, d.nextSibling) : c.appendChild(b) :
            c.insertBefore(b, c.firstChild), N.push(b);
        else if ("bottom" === a.insertAt) c.appendChild(b);
        else if ("object" === typeof a.insertAt && a.insertAt.before) a = L(a.insertInto + " " + a.insertAt.before), c.insertBefore(b, a);
            ...
            return function (a) {
                ...
                if ("undefined" === typeof b[a]) {
                    ...
                    if (window.HTMLIFrameElement &&
                        c instanceof window.HTMLIFrameElement) try { c = c.contentDocument.head } catch (Ca) { c = null }
                    b[a] = c
                }
                return b[a]
            }
